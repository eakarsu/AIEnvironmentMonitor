...
const FEATURES = [
  { kind: 'cfs', slug: 'cf-real-time-carbon-tracker', label: 'Real-time carbon tracker', desc: 'Stream from smart meters, live carbon intensity', endpoint: '/cf-real-time-carbon-tracker' },
  { kind: 'cfs', slug: 'cf-offset-marketplace', label: 'Offset marketplace', desc: 'Verified offset purchase in-app', endpoint: '/cf-offset-marketplace' },
  { kind: 'cfs', slug: 'cf-scope-3-supply-chain-agent', label: 'Scope-3 supply-chain agent', desc: 'Procurement emissions estimator', endpoint: '/cf-scope-3-supply-chain-agent' },
  { kind: 'cfs', slug: 'cf-workplace-gamification', label: 'Workplace gamification', desc: 'Eco-behavior badges, team leaderboards', endpoint: '/cf-workplace-gamification' },
  { kind: 'cfs', slug: 'cf-smb-scope-1-2-3-wizard', label: 'SMB Scope 1/2/3 wizard', desc: 'Simplified accounting', endpoint: '/cf-smb-scope-1-2-3-wizard' },
  { kind: 'cfs', slug: 'cf-behavioural-nudges', label: 'Behavioural nudges', desc: 'Triggered notifications on high usage', endpoint: '/cf-behavioural-nudges' },
  { kind: 'cfs', slug: 'cf-utility-api-ingest', label: 'Utility-API ingest', desc: 'Opower-style usage pull', endpoint: '/cf-utility-api-ingest' },
  { kind: 'gap-ai', slug: 'gap-ai-no-carbon-offset-marketplace-agent', label: 'No carbon-offset marketplace agent', desc: 'No carbon-offset marketplace agent', endpoint: '/gap-no-carbon-offset-marketplace-agent' },
  { kind: 'gap-ai', slug: 'gap-ai-no-scope-3-supply-chain-auto-aggregation', label: 'No Scope-3 supply-chain auto-aggregation', desc: 'No Scope-3 supply-chain auto-aggregation', endpoint: '/gap-no-scope-3-supply-chain-auto-aggregation' },
  { kind: 'gap-ai', slug: 'gap-ai-no-team-gamification-logic', label: 'No team gamification logic', desc: 'No team gamification logic', endpoint: '/gap-no-team-gamification-logic' },
  { kind: 'gap-non', slug: 'gap-non-no-team-management-endpoint-observed-single-tenant-feel', label: 'No team-management endpoint observed (single-tenant feel)', desc: 'No team-management endpoint observed (single-tenant feel)', endpoint: '/gap-no-team-management-endpoint-observed-single-tenant-feel' },
  { kind: 'gap-non', slug: 'gap-non-no-leaderboards-gamification-module', label: 'No leaderboards / gamification module', desc: 'No leaderboards / gamification module', endpoint: '/gap-no-leaderboards-gamification-module' },
  { kind: 'gap-non', slug: 'gap-non-limited-utility-api-integration-no-opower-style-connector', label: 'Limited utility-API integration (no Opower-style connector)', desc: 'Limited utility-API integration (no Opower-style connector)', endpoint: '/gap-limited-utility-api-integration-no-opower-style-connector' },
  { kind: 'gap-non', slug: 'gap-non-no-payment-marketplace-processing', label: 'No payment/marketplace processing', desc: 'No payment/marketplace processing', endpoint: '/gap-no-payment-marketplace-processing' },
];
...
export default function Batch03Features() {
  ...
  return (
    <div style={{ padding: 24, fontFamily: 'system-ui, sans-serif' }}>
      <h2 style={{ marginTop: 0 }}>Batch 03 Features <small style={{ color: '#64748b', fontWeight: 400 }}>(AIEnvironmentMonitor)</small></h2>
